      ...
      <div ref={ref} className="section-hidden space-y-10">
        ...
        <div className="flex justify-center">
          ...
          >
            ...
            <span className="font-display font-bold tracking-wider text-lg">✅ Validado por Humano</span>
            <div className="w-3 h-3 rounded-full bg-blue-400 animate-pulse" />
          </div>
        </div>
        ...
        >
          <blockquote className="text-base md:text-lg text-purple-100 italic leading-relaxed">
            "Vamos construir o futuro ou apenas sermos processados por ele?"
          </blockquote>
          <div className="text-sm text-purple-400">— Thales Pires, Founder & CEO · Oráculo de SophIA</div>
